...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@twick/core"><img src="https://img.shields.io/npm/v/@twick/core?style=flat" alt="npm package version"></a>
...
[examples repository](https://github.com/ncounterspecialist/twick-examples), and join
our [Discord server](https://discord.com/invite/MVJsrqjy3j).

#### News 🔥

- [05/21/2024] We released an
  [example](https://github.com/redotvideo/twick-examples/tree/main/google-cloud-run-parallelized)
...
```tsx
import {Audio, Img, Video, makeScene2D} from '@twick/2d';
import {all, chain, createRef, waitFor} from '@twick/core';
...
export default makeScene2D('scene', function* (view) {
  ...
  yield view.add(
    <>
      <Video
        src={'https://twick-example-assets.s3.amazonaws.com/stars.mp4'}
        size={['100%', '100%']}
        play={true}
      />
      <Audio
        src={'https://twick-example-assets.s3.amazonaws.com/chill-beat.mp3'}
        play={true}
        time={17.0}
      />
    </>,
  ...
  view.add(
    <Img
      ...
      ref={logoRef}
      src={
        'https://twick-example-assets.s3.amazonaws.com/twick-logo-white.png'
      }
    />,
  );
...
https://github.com/ncounterspecialist/twick-base/assets/122226645/4d4e56ba-5143-4e4b-9acf-d8a04330d162
...
- **Headless Rendering:** Motion Canvas currently requires you to press a button
  ...
  ([example](https://github.com/redotvideo/twick-examples/tree/main/google-cloud-run),
...
- **Faster Rendering:** When building an app rather than creating videos for
  ...
  speeds by enabling
  [parallelized rendering](https://github.com/redotvideo/twick/pull/74) and
  replacing the `seek()` operation for HTML video with our ffmpeg-based
  [video frame extractor](https://github.com/redotvideo/twick/pull/33)
...
[here](https://github.com/redotvideo/twick/tree/main/packages/telemetry).
